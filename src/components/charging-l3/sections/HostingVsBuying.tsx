    ...
    <section style={{ background: '#0a0a0a', position: 'relative', zIndex: 1, isolation: 'isolate', padding: '80px 32px', textAlign: 'center' }}>
      ...
      <div className="cl3-hosting-grid" style={{ display: 'flex', flexDirection: 'row', gap: 50, justifyContent: 'center', maxWidth: 1128, margin: '0 auto' }}>
        <div style={cardBase}>
          ...
          <a href={`/${lang}/join?profile=energy`} style={{ display: 'block', width: '100%', padding: '12px 20px', background: 'rgba(255,255,255,.1)', backdropFilter: 'blur(26px)', border: '1px solid rgba(255,255,255,.1)', borderRadius: 15, color: '#fff', fontSize: 15, fontWeight: 600, textDecoration: 'none', textAlign: 'center' }}>{t(lang, 'chargingL3.hosting.buyCta')}</a>
        </div>
