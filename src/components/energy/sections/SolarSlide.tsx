...
const slides = [
  {
    titleKey: 'energyHome.install.title',
    descKey: 'energyHome.install.desc',
    bg: 'slide-wifi.webp',
    cta: 'energyHome.flow.cta',
  },
  {
    titleKey: 'energyHome.flow.lights.title',
    descKey: 'energyHome.flow.lights.desc',
    bg: 'slide-lights.webp',
    cta: 'energyHome.flow.cta',
  },
  {
    titleKey: 'energyHome.flow.fridge.title',
    descKey: 'energyHome.flow.fridge.desc',
    bg: 'slide-fridge.webp',
    cta: 'energyHome.flow.cta',
  },
  {
    titleKey: 'energyHome.flow.ac.title',
    descKey: 'energyHome.flow.ac.desc',
    bg: 'slide-ac.webp',
    cta: 'energyHome.flow.cta',
  },
];
    ...
    <section className="eh-slide" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
      ...
      <div className="eh-slide-content">
        <div className="eh-slide-panel">
          ...
          <button type="button" className="eh-cta-glass" style={{marginTop:12}}>{t(lang, slides[active].cta)}</button>
        </div>
