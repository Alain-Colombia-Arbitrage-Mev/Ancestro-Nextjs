  ...
  return (
    <section className="eh-clean">
      ...
      <style>{`
        ...
        .eh-clean-desc{font-size:20px;font-weight:400;line-height:1.6;color:#a3a3a3;text-align:center;margin:0;max-width:650px;white-space:pre-line}
        @media(max-width:1024px){
          .eh-clean{min-height:550px}
          .eh-clean-inner{padding:80px 40px 60px}
          .eh-clean-title{font-size:28px}
          .eh-clean-desc{font-size:18px}
        }
