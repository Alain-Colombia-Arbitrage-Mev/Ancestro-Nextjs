  ...
  return (
    <section className="eh-hero">
      ...
      <style>{`
        ...
        .eh-hero-video{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}
        ...
        .eh-hero-content{position:relative;z-index:1;text-align:center;padding:0 24px}
        .eh-hero-title{font-size:50px;font-weight:600;line-height:1.05;color:#fff;margin:0;text-shadow:0 2px 20px rgba(0,0,0,.5)}
        .eh-hero-sub{font-size:20px;font-weight:600;color:#fff;margin:16px 0 0;text-shadow:0 2px 12px rgba(0,0,0,.5)}
        .eh-hero-cta-wrap{position:absolute;bottom:80px;z-index:1}
        .eh-cta-glass{padding:12px 30px;background:rgba(255,255,255,.1);backdrop-filter:blur(26px);-webkit-backdrop-filter:blur(26px);border:1px solid rgba(255,255,255,.15);border-radius:15px;color:#fff;font-family:inherit;font-size:16px;font-weight:600;cursor:pointer;transition:all .3s ease}
        .eh-cta-glass:hover{background:rgba(248,176,59,.2);border-color:rgba(248,176,59,.5)}
        @media(max-width:768px){
          .eh-hero{min-height:600px}
          .eh-hero-title{font-size:36px}
