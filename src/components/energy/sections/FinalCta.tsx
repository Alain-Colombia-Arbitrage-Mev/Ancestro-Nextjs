  ...
  return (
    <section className="eh-final">
      ...
      <style>{`
        ...
        .eh-final-cta{padding:14px 40px;min-height:44px;border-radius:30px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.2);color:#fff;font-size:16px;cursor:pointer;backdrop-filter:blur(10px);transition:all .3s ease}
        .eh-final-cta:hover{background:rgba(255,255,255,.2)}
        @media(max-width:1024px){
          .eh-final-inner{padding:80px 40px}
          .eh-final-title{font-size:28px}
        }
